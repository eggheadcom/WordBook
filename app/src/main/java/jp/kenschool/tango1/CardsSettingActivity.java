...
public class CardsSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cards_setting);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(chPrevious.isChecked()){
                    prev = " AND (last_ans = 0 AND cnt > 0)"; //1回以上挑戦したもので
                }
                ...
                if(inputCheck){         //入力チェックでfalseになっていなければ実行
                    ...
                    if(data.size() != 0) {
                        ...
                        //画面遷移  通常の問題
                        Intent intent = new Intent(CardsSettingActivity.this, CardsActivity.class);
